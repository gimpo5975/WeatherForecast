...
const mykey = 'b98b506e6a7ee8a8c28d2b2e10b77a17';
...
$ (function () {
  ...
  if (key == '') {
    ...
    let locationService;
    //기본은 navigator.geolocation으로 받는것으로한다. 하지만 값이 없으면 
    //여전히 app.geolocation은 flase일 것이다.
    ...
    locationService.geolocation.getCurrentPosition (function (position) {
      myLat = position.coords.latitude;
      myLon = position.coords.longitude;
      getWeather (myLat, myLon, '');
    },
    function(error){},
    {enableHightAccuracy: true, timeout: 15000, maximumAge: 0}
    );
  }
}); //jquery
